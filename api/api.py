# This is here just for reference and will be removed eventually.
import datetime
import ipaddress
import json
import re
...
def add_proxy(json_body: dict, user_doc: dict) -> Response:
    ...
    if new_proxy.inserted_id:
        ...
        send_NSQ({"action": 2, "message_data":{
...
def delete_proxy(json_body: dict, user_doc: dict) -> Response:
    ...
    if deleted_proxy.deleted_count == 1:
        ...
        send_NSQ({"action": 3, "message_data":{
...
def sync_domains_to_nsq():
    send_NSQ({"action": 4, "message_data":{
        "Name": "null",
        "IP": "null",
    }}, "aarch64-proxy")
